...
var require_dist = __commonJS({
  "node_modules/.pnpm/jsdoc-type-pratt-parser@4.8.0/node_modules/jsdoc-type-pratt-parser/dist/index.js"(exports, module) {
    (function(global2, factory) {
      ...
      function parse4(expression, mode) {
        switch (mode) {
          case "closure":
      ...
      const catharsisTransformRules = {
        ...
        JsdocTypeGeneric: (result, transform2) => ({
          ...
          applications: result.elements.map((o3) => transform2(o3)),
...
// node_modules/.pnpm/@storybook+addon-docs@8.6.14_@types+react@19.2.14_storybook@8.6.18/node_modules/@storybook/addon-docs/dist/chunk-NUUEMKO5.mjs
var import_react2 = __toESM(require_react(), 1);

// node_modules/.pnpm/@storybook+blocks@8.6.14_react-dom@19.2.4_react@19.2.4__react@19.2.4_storybook@8.6.18/node_modules/@storybook/blocks/dist/index.mjs
...
var o = (e, t2) => De(e, "name", { value: t2, configurable: true });
...
var Pe = o((e) => {
  switch (e.type) {
    ...
    case "object":
      let t2 = {};
      return e.signature.properties.forEach((r2) => {
        t2[r2.key] = d(r2.value);
      }), {
        name: "object",
        value: t2
      };
...
var d = o((e) => {
  var _a, _b, _c, _d;
  let { name: t2, raw: r2 } = e, n2 = {};
  switch (typeof r2 < "u" && (n2.raw = r2), e.name) {
    case "literal":
      return { ...n2, name: "other", value: e.value };
    case "string":
    case "number":
    case "symbol":
    case "boolean":
      return { ...n2, name: t2 };
    case "Array":
      return { ...n2, name: "array", value: e.elements.map(d) };
    case "signature":
      return { ...n2, ...Pe(e) };
    case "union":
      return ((_a = e.elements) == null ? void 0 : _a.every(he)) ? { ...n2, name: "enum", value: (_b = e.elements) == null ? void 0 : _b.map(be) } : { ...n2, name: t2, value: (_c = e.elements) == null ? void 0 : _c.map(d) };
    case "intersection":
      return { ...n2, name: t2, value: (_d = e.elements) == null ? void 0 : _d.map(d) };
    default:
      return { ...n2, name: "other", value: t2 };
  }
}, "convert");
function j(e, t2) {
  let r2 = {}, n2 = Object.keys(e);
  for (let s2 = 0; s2 < n2.length; s2++) {
    let i2 = n2[s2], p2 = e[i2];
    r2[i2] = t2(p2, i2, e);
  }
  return r2;
}
...
var h = o((e) => {
  let t2 = Se(e);
  return Oe(e) || Number.isNaN(Number(t2)) ? t2 : Number(t2);
}, "parseLiteral");
var ve = /^\(.*\) => /;
var x = o((e) => {
  let { name: t2, raw: r2, computed: n2, value: s2 } = e, i2 = {};
  switch (typeof r2 < "u" && (i2.raw = r2), t2) {
    case "enum": {
      let a2 = n2 ? s2 : s2.map((c2) => h(c2.value));
      return { ...i2, name: t2, value: a2 };
    }
    case "string":
    case "number":
    case "symbol":
      return { ...i2, name: t2 };
    case "func":
      return { ...i2, name: "function" };
    case "bool":
    case "boolean":
      return { ...i2, name: "boolean" };
    case "arrayOf":
    case "array":
      return { ...i2, name: "array", value: s2 && x(s2) };
    case "object":
      return { ...i2, name: t2 };
    case "objectOf":
      return { ...i2, name: t2, value: x(s2) };
    case "shape":
    case "exact":
      let p2 = j(s2, (a2) => x(a2));
      return { ...i2, name: "object", value: p2 };
    case "union":
      return { ...i2, name: "union", value: s2.map((a2) => x(a2)) };
    case "instanceOf":
    case "element":
    case "elementType":
    default: {
      if ((t2 == null ? void 0 : t2.indexOf("|")) > 0)
        try {
          let u2 = t2.split("|").map((m2) => JSON.parse(m2));
          return { ...i2, name: "enum", value: u2 };
        } catch {
        }
      let a2 = s2 ? `${t2}(${s2})` : t2, c2 = ve.test(t2) ? "function" : "other";
      return { ...i2, name: c2, value: a2 };
    }
  }
}, "convert");
var Ee = o((e) => {
...
var D = o((e) => {
  ...
  switch (typeof r2 < "u" && (n2.raw = r2), e.name) {
    ...
    case "union":
      let s2;
      return ((_a = e.elements) == null ? void 0 : _a.every((i2) => i2.name === "literal")) ? s2 = {
        ...n2,
        name: "enum",
        // @ts-expect-error fix types
        value: (_b = e.elements) == null ? void 0 : _b.map((i2) => h(i2.value))
      } : s2 = { ...n2, name: t2, value: (_c = e.elements) == null ? void 0 : _c.map(D) }, s2;
    case "intersection":
      return { ...n2, name: t2, value: (_d = e.elements) == null ? void 0 : _d.map(D) };
    default:
      return { ...n2, name: "other", value: t2 };
...
var b = o((e) => {
  let { type: t2, tsType: r2, flowType: n2 } = e;
  try {
    if (t2 != null)
      return x(t2);
    if (r2 != null)
...
function Y(e, t2) {
  return z2(e) ? e.__docgenInfo[t2] : null;
}
o(Y, "getDocgenSection");
function q(e) {
  return z2(e) ? M(e.__docgenInfo.description) : "";
}
...
function G(e) {
  let t2 = e.match(/\r+$/);
  return t2 == null ? ["", e] : [e.slice(-t2[0].length), e.slice(0, -t2[0].length)];
}
o(G, "splitCR");
function y(e) {
  let t2 = e.match(/^\s+/);
  return t2 == null ? ["", e] : [e.slice(0, t2[0].length), e.slice(t2[0].length)];
}
o(y, "splitSpace");
function K(e) {
  return e.split(/\n/);
...
var Fe = /^@\S+/;
function J({ fence: e = "```" } = {}) {
  let t2 = Je(e), r2 = o((n2, s2) => t2(n2) ? !s2 : s2, "toggleFence");
  return o(function(s2) {
    let i2 = [[]], p2 = false;
    for (let a2 of s2)
      Fe.test(a2.tokens.description) && !p2 ? i2.push([a2]) : i2[i2.length - 1].push(a2), p2 = r2(a2.tokens.description, p2);
    return i2;
  }, "parseBlock");
}
o(J, "getParser");
function Je(e) {
  return typeof e == "string" ? (t2) => t2.split(e).length % 2 === 0 : e;
}
o(Je, "getFencer");
function N2({ startLine: e = 0, markers: t2 = f } = {}) {
  let r2 = null, n2 = e;
  return o(function(i2) {
    let p2 = i2, a2 = F();
    if ([a2.lineEnd, p2] = G(p2), [a2.start, p2] = y(p2), r2 === null && p2.startsWith(t2.start) && !p2.startsWith(t2.nostart) && (r2 = [], a2.delimiter = p2.slice(0, t2.start.length), p2 = p2.slice(t2.start.length), [a2.postDelimiter, p2] = y(p2)), r2 === null)
      return n2++, null;
    let c2 = p2.trimRight().endsWith(t2.end);
    if (a2.delimiter === "" && p2.startsWith(t2.delim) && !p2.startsWith(t2.end) && (a2.delimiter = t2.delim, p2 = p2.slice(t2.delim.length), [
      a2.postDelimiter,
      p2
    ] = y(p2)), c2) {
      let u2 = p2.trimRight();
      a2.end = p2.slice(u2.length - t2.end.length), p2 = u2.slice(0, -t2.end.length);
    }
    if (a2.description = p2, r2.push({ number: n2, source: i2, tokens: a2 }), n2++, c2) {
      let u2 = r2.slice();
      return r2 = null, u2;
    }
    return null;
...
function R({ tokenizers: e }) {
  return o(function(r2) {
    var n2;
    let s2 = X({ source: r2 });
    for (let i2 of e)
      if (s2 = i2(s2), !((n2 = s2.problems[s2.problems.length - 1]) === null || n2 === void 0) && n2.critical)
        break;
    return s2;
  }, "parseSpec");
}
...
function P() {
  return (e) => {
    let { tokens: t2 } = e.source[0], r2 = t2.description.match(/\s*(@(\S+))(\s*)/);
    return r2 === null ? (e.problems.push({
      code: "spec:tag:prefix",
      message: 'tag should start with "@" symbol',
      line: e.source[0].number,
      critical: true
    }), e) : (t2.tag = r2[1], t2.postTag = r2[3], t2.description = t2.description.slice(r2[0].length), e.tag = r2[2], e);
  };
}
o(P, "tagTokenizer");
function S(e = "compact") {
  ...
  return (r2) => {
    let n2 = 0, s2 = [];
    for (let [a2, { tokens: c2 }] of r2.source.entries()) {
      let u2 = "";
      if (a2 === 0 && c2.description[0] !== "{")
        return r2;
      for (let m2 of c2.description)
        if (m2 === "{" && n2++, m2 === "}" && n2--, u2 += m2, n2 === 0)
          break;
      if (s2.push([c2, u2]), n2 === 0)
        break;
    }
    if (n2 !== 0)
      return r2.problems.push({
        code: "spec:type:unpaired-curlies",
        message: "unpaired curlies",
        line: r2.source[0].number,
        critical: true
      }), r2;
    let i2 = [], p2 = s2[0][0].postDelimiter.length;
    for (let [a2, [c2, u2]] of s2.entries())
      c2.type = u2, a2 > 0 && (c2.type = c2.postDelimiter.slice(p2) + u2, c2.postDelimiter = c2.postDelimiter.slice(0, p2)), [c2.postType, c2.description] = y(c2.description.slice(u2.length)), i2.push(c2.type);
    return i2[0] = i2[0].slice(1), i2[i2.length - 1] = i2[i2.length - 1].slice(0, -1), r2.type = t2(i2), r2;
  };
}
o(S, "typeTokenizer");
var Ne = o((e) => e.trim(), "trim");
function Re(e) {
  return e === "compact" ? (t2) => t2.map(Ne).join("") : e === "preserve" ? (t2) => t2.join(`
`) : e;
}
o(Re, "getJoiner");
var Ae = o((e) => e && e.startsWith('"') && e.endsWith('"'), "isQuoted");
function O() {
  let e = o((t2, { tokens: r2 }, n2) => r2.type === "" ? t2 : n2, "typeEnd");
  return (t2) => {
    let { tokens: r2 } = t2.source[t2.source.reduce(e, 0)], n2 = r2.description.trimLeft(), s2 = n2.split('"');
    if (s2.length > 1 && s2[0] === "" && s2.length % 2 === 1)
      return t2.name = s2[1], r2.name = `"${s2[1]}"`, [r2.postName, r2.description] = y(n2.slice(r2.name.length)), t2;
    let i2 = 0, p2 = "", a2 = false, c2;
    for (let m2 of n2) {
      if (i2 === 0 && k(m2))
        break;
      m2 === "[" && i2++, m2 === "]" && i2--, p2 += m2;
    ...
    if (i2 !== 0)
      return t2.problems.push({
        code: "spec:name:unpaired-brackets",
        message: "unpaired brackets",
        line: t2.source[0].number,
        critical: true
      }), t2;
    let u2 = p2;
    if (p2[0] === "[" && p2[p2.length - 1] === "]") {
      a2 = true, p2 = p2.slice(1, -1);
      let m2 = p2.split("=");
      if (p2 = m2[0].trim(), m2[1] !== void 0 && (c2 = m2.slice(1).join("=").trim()), p2 === "")
        return t2.problems.push({
    ...
    return t2.optional = a2, t2.name = p2, r2.name = u2, c2 !== void 0 && (t2.default = c2), [r2.postName, r2.description] = y(n2.slice(r2.name.length)), t2;
  };
}
o(O, "nameTokenizer");
function v(e = "compact", t2 = f) {
  let r2 = A(e);
  return (n2) => (n2.description = r2(n2.source, t2), n2);
}
...
o(A, "getJoiner");
function Ve(e, t2 = f) {
  return e.map(({ tokens: { description: r2 } }) => r2.trim()).filter((r2) => r2 !== "").join(" ");
}
o(Ve, "compactJoiner");
var Ce = o((e, { tokens: t2 }, r2) => t2.type === "" ? e : r2, "lineNo");
var _e2 = o(({ tokens: e }) => (e.delimiter === "" ? e.start : e.postDelimiter.slice(1)) + e.description, "getDescription");
function Be(e, t2 = f) {
  if (e.length === 0)
    return "";
  e[0].tokens.description === "" && e[0].tokens.delimiter === t2.start && (e = e.slice(1));
  let r2 = e[e.length - 1];
  return r2 !== void 0 && r2.tokens.description === "" && r2.tokens.end.endsWith(t2.end) && (e = e.slice(0, -1)), e = e.slice(e.reduce(Ce, 0)), e.map(_e2).join(`
`);
}
o(Be, "preserveJoiner");
function V({ startLine: e = 0, fence: t2 = "```", spacing: r2 = "compact", markers: n2 = f, tokenizers: s2 = [
  P(),
  S(r2),
  O(),
  v(r2)
  ...
  let i2 = N2({ startLine: e, markers: n2 }), p2 = J({ fence: t2 }), a2 = R({ tokenizers: s2 }), c2 = A(r2);
  return function(u2) {
    let m2 = [];
    for (let ge2 of K(u2)) {
      let E2 = i2(ge2);
      if (E2 === null)
        continue;
      let L2 = p2(E2), U2 = L2.slice(1).map(a2);
      m2.push({
        description: c2(L2[0], n2),
        tags: U2,
        source: E2,
        problems: U2.reduce((de2, xe2) => de2.concat(xe2.problems), [])
      });
    }
    return m2;
  };
...
o(Ie, "join");
function C() {
  return (e) => e.source.map(({ tokens: t2 }) => Ie(t2)).join(`
`);
}
o(C, "getStringifier");
var Le = {
...
var Q = o((e, t2 = Ye) => {
  ...
  return n2.ignore ? {
    ...
    description: r2.description.trim(),
    extractedTags: n2
  };
}, "parseJsDoc");
function qe(e, t2) {
  ...
  for (let n2 of e.tags)
    if (!(t2 !== void 0 && !t2.includes(n2.tag)))
      if (n2.tag === "ignore") {
        r2.ignore = true;
        break;
      } else
        switch (n2.tag) {
          ...
          case "argument": {
            let s2 = Ke(n2);
            s2 != null && (r2.params == null && (r2.params = []), r2.params.push(s2));
            break;
          }
          case "deprecated": {
            let s2 = Xe(n2);
            s2 != null && (r2.deprecated = s2);
            break;
          }
          case "returns": {
            let s2 = He(n2);
            s2 != null && (r2.returns = s2);
            break;
          }
          default:
            break;
...
function Ke(e) {
  ...
  return {
    ...
    getTypeName: o(() => t2 ? re(t2) : null, "getTypeName")
  };
}
o(Ke, "extractParam");
function Xe(e) {
...
function He(e) {
  ...
  return t2 ? {
    ...
    getTypeName: o(() => re(t2), "getTypeName")
  } : null;
}
o(He, "extractReturns");
...
g.JsdocTypeAny = () => "any";
g.JsdocTypeObject = (e, t2) => `(${Qe(e, t2)})`;
g.JsdocTypeOptional = (e, t2) => t2(e.element);
g.JsdocTypeNullable = (e, t2) => t2(e.element);
g.JsdocTypeNotNullable = (e, t2) => t2(e.element);
g.JsdocTypeUnion = (e, t2) => e.elements.map(t2).join("|");
function te2(e) {
  try {
...
function l(e, t2) {
  return e === t2 ? { summary: e } : { summary: e, detail: t2 };
}
...
function ne(e, t2) {
  if (e != null) {
    let { value: r2 } = e;
    if (!T(r2))
      return oe(r2) ? l(t2 == null ? void 0 : t2.name, r2) : l(r2);
  }
  return null;
}
o(ne, "createDefaultValue");
function se({ name: e, value: t2, elements: r2, raw: n2 }) {
  return t2 ?? (r2 != null ? r2.map(se).join(" | ") : n2 ?? e);
}
o(se, "generateUnionElement");
function Ze({ name: e, raw: t2, elements: r2 }) {
  return r2 != null ? l(r2.map(se).join(" | ")) : t2 != null ? l(t2.replace(/^\|\s*/, "")) : l(e);
}
o(Ze, "generateUnion");
function et({ type: e, raw: t2 }) {
  return t2 != null ? l(t2) : l(e);
}
o(et, "generateFuncSignature");
function tt({ type: e, raw: t2 }) {
  return t2 != null ? B(t2) ? l(e, t2) : l(t2) : l(e);
}
o(tt, "generateObjectSignature");
function rt(e) {
  let { type: t2 } = e;
  return t2 === "object" ? tt(e) : et(e);
}
o(rt, "generateSignature");
function ot({ name: e, raw: t2 }) {
  return t2 != null ? B(t2) ? l(e, t2) : l(t2) : l(e);
}
...
o(ie, "createType");
var pe = o((e, t2) => {
  let { flowType: r2, description: n2, required: s2, defaultValue: i2 } = t2;
  return {
    name: e,
    type: ie(r2),
    required: s2,
    description: n2,
    defaultValue: ne(i2 ?? null, r2 ?? null)
  };
}, "createFlowPropDef");
...
function ce({ tsType: e, required: t2 }) {
  if (e == null)
    return null;
  let r2 = e.name;
  return t2 || (r2 = r2.replace(" | undefined", "")), l(
    ["Array", "Record", "signature"].includes(e.name) ? e.raw : r2
  );
}
o(ce, "createType");
var le = o((e, t2) => {
  let { description: r2, required: n2 } = t2;
  return {
    name: e,
    type: ce(t2),
    required: n2,
...
function pt(e, t2) {
  if (e != null) {
    let { value: r2 } = e;
    if (!T(r2))
      return st(e) && it(t2) ? l(JSON.stringify(r2)) : l(r2);
  }
  return null;
}
o(pt, "createDefaultValue");
function ue(e, t2, r2) {
  let { description: n2, required: s2, defaultValue: i2 } = r2;
  return {
    name: e,
    type: nt(t2),
    required: s2,
    description: n2,
    defaultValue: pt(i2, t2)
  };
}
o(ue, "createBasicPropDef");
function w(e, t2) {
  var _a;
  if (t2 == null ? void 0 : t2.includesJsDoc) {
    let { description: r2, extractedTags: n2 } = t2;
    r2 != null && (e.description = t2.description);
    let s2 = {
      ...n2,
      params: (_a = n2 == null ? void 0 : n2.params) == null ? void 0 : _a.map(
        (i2) => ({
          name: i2.getPrettyName(),
...
var at = o((e, t2, r2) => {
  let n2 = ue(e, t2.type, t2);
  return n2.sbType = b(t2), w(n2, r2);
}, "javaScriptFactory");
var ct = o((e, t2, r2) => {
  let n2 = le(e, t2);
  return n2.sbType = b(t2), w(n2, r2);
...
var mt = o((e) => {
  let t2 = me(e[0]), r2 = I(t2);
  return e.map((n2) => {
    var _a;
    let s2 = n2;
    return ((_a = n2.type) == null ? void 0 : _a.elements) && (s2 = {
      ...n2,
      type: {
        ...n2.type,
        value: n2.type.elements
      }
    }), fe(s2.name, s2, t2, r2);
  });
}, "extractComponentSectionArray");
var ft = o((e) => {
  let t2 = Object.keys(e), r2 = me(e[t2[0]]), n2 = I(r2);
  return t2.map((s2) => {
    let i2 = e[s2];
    return i2 != null ? fe(s2, i2, r2, n2) : null;
  }).filter(Boolean);
}, "extractComponentSectionObject");
var on = o((e, t2) => {
  let r2 = Y(e, t2);
  return $(r2) ? Array.isArray(r2) ? mt(r2) : ft(r2) : [];
}, "extractComponentProps");
function fe(e, t2, r2, n2) {
  let s2 = Q(t2.description);
...
var cn = o((e) => {
  let {
    ...
    argTypes: r2,
    parameters: { docs: n2 = {} }
  } = e, { extractArgTypes: s2 } = n2, i2 = s2 && t2 ? s2(t2) : {};
  return i2 ? (0, import_preview_api.combineParameters)(i2, r2) : r2;
}, "enhanceArgTypes");
var ye = "storybook/docs";
var mn = `${ye}/panel`;
var yn = `${ye}/snippet-rendered`;
var gt = ((n2) => (n2.AUTO = "auto", n2.CODE = "code", n2.DYNAMIC = "dynamic", n2))(gt || {});
var dt = /(addons\/|addon-|addon-essentials\/)(docs|controls)/;
var dn = o((e) => {
  var _a;
  return (_a = e.presetsList) == null ? void 0 : _a.some((t2) => dt.test(t2.name));
}, "hasDocsOrControls");
...
var require_memoizerific = __commonJS2({ "../../node_modules/memoizerific/memoizerific.js"(exports, module) {
  (function(f3) {
    if (typeof exports == "object" && typeof module < "u") module.exports = f3();
      ...
      var g22;
      typeof window < "u" ? g22 = window : typeof global < "u" ? g22 = global : typeof self < "u" ? g22 = self : g22 = this, g22.memoizerific = f3();
    }
  })(function() {
    return (function e2(t2, n2, r2) {
      ...
      for (var i2 = typeof __require == "function" && __require, o22 = 0; o22 < r2.length; o22++) s2(r2[o22]);
      return s2;
...
var require_build_html = __commonJS2({ "../../node_modules/tocbot/src/js/build-html.js"(exports, module) {
  module.exports = function(options2) {
    ...
    function createEl(d22, container) {
      var link = container.appendChild(createLink(d22));
      if (d22.children.length) {
        var list = createList(d22.isCollapsed);
        d22.children.forEach(function(child) {
          createEl(child, list);
...
var require_scroll_smooth = __commonJS2({ "../../node_modules/tocbot/src/js/scroll-smooth/index.js"(exports) {
  ...
  function jump(target, options2) {
    ...
    function easeInOutQuad(t2, b22, c2, d22) {
      return t2 /= d22 / 2, t2 < 1 ? c2 / 2 * t2 * t2 + b22 : (t2--, -c2 / 2 * (t2 * (t2 - 2) - 1) + b22);
    }
  }
} });
...
function _construct(t2, e2, r2) {
  ...
  var p2 = new (t2.bind.apply(t2, o22))();
...
function format() {
  ...
  var a2 = args2[0], b22 = [], c2;
  for (c2 = 1; c2 < args2.length; c2 += 1) b22.push(args2[c2]);
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-VELNWZKU.js");
...
var l2 = ["allowFullScreen", "allowTransparency", "autoComplete", "autoFocus", "autoPlay", "cellPadding", "cellSpacing", "charSet", "classId", "colSpan", "contentEditable", "contextMenu", "crossOrigin", "encType", "formAction", "formEncType", "formMethod", "formNoValidate", "formTarget", "frameBorder", "hrefLang", "inputMode", "keyParams", "keyType", "marginHeight", "marginWidth", "maxLength", "mediaGroup", "minLength", "noValidate", "radioGroup", "readOnly", "rowSpan", "spellCheck", "srcDoc", "srcLang", "srcSet", "tabIndex", "useMap"].reduce((e2, t2) => (e2[t2.toLowerCase()] = t2, e2), { class: "className", for: "htmlFor" });
...
var O2 = /^<!--[\s\S]*?(?:-->)/;
var B2 = /^(data|aria|x)-[a-z_][a-z\d_.-]*$/;
var M2 = /^ *<([a-z][a-z0-9:]*)(?:\s+((?:<.*?>|[^>])*))?\/?>(?!<\/\1>)(\s*\n)?/i;
var R2 = /^\{.*\}$/;
var I2 = /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/;
var U = /^<([^ >]+@[^ >]+)>/;
var D2 = /^<([^ >]+:\/[^ >]+)>/;
...
var Q2 = /^ *-+: *$/;
var V2 = "((?:\\[.*?\\][([].*?[)\\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~~.*?~~|==.*?==|.|\\n)*?)";
var X2 = new RegExp(`^([*_])\\1${V2}\\1\\1(?!\\1)`);
var J2 = new RegExp(`^([*_])${V2}\\1(?!\\1|\\w)`);
var K2 = new RegExp(`^==${V2}==`);
var Y2 = new RegExp(`^~~${V2}~~`);
var ee2 = /^\\([^0-9A-Za-z\s])/;
...
var be2 = ke2(2);
function ve2(e2, t2) {
  let n2 = t2 === 1, i2 = n2 ? xe : be2, l22 = n2 ? ge : ye2, a2 = n2 ? fe2 : he2;
  return { match(e3, t3) {
    let n3 = ae2.exec(t3.prevCapture);
    return n3 && (t3.list || !t3.inline && !t3.simple) ? i2.exec(e3 = n3[1] + e3) : null;
  }, order: 1, parse(e3, t3, r2) {
    let i3 = n2 ? +e3[2] : void 0, o22 = e3[0].replace(d2, `
`).match(l22), c2 = false;
    return { items: o22.map(function(e4, n3) {
      let i4 = a2.exec(e4)[0].length, l3 = new RegExp("^ {1," + i4 + "}", "gm"), s2 = e4.replace(l3, "").replace(a2, ""), d22 = n3 === o22.length - 1, p2 = s2.indexOf(`

`) !== -1 || d22 && c2;
      c2 = p2;
      let u2 = r2.inline, f3 = r2.list, h22;
      r2.list = true, p2 ? (r2.inline = false, h22 = s2.replace(le2, `

`)) : (r2.inline = true, h22 = s2.replace(le2, ""));
      let m2 = t3(h22, r2);
...
var Se2 = new RegExp(`^\\[((?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*)\\]\\(\\s*<?((?:\\([^)]*\\)|[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*\\)`);
var Ce2 = /^!\[(.*?)\]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/;
var $e2 = [p, g2, y2, w2, L, z3, O2, j2, ge, xe, ye2, be2];
var Ee2 = [...$e2, /^[^\n]+(?:  \n|\n{2,})/, A2, M2];
function we2(e2) {
...
function ze2(e2) {
  return Q2.test(e2) ? "right" : Z2.test(e2) ? "center" : q2.test(e2) ? "left" : null;
}
function Le2(e2, t2, n2, i2) {
  let l22 = n2.inTable;
  n2.inTable = true;
  ...
  return a2.forEach(function(e3, t3) {
    e3.type === r.tableSeparator ? t3 !== 0 && t3 !== a2.length - 1 && o22.push([]) : (e3.type !== r.text || a2[t3 + 1] != null && a2[t3 + 1].type !== r.tableSeparator || (e3.text = e3.text.trimEnd()), o22[o22.length - 1].push(e3));
  }), o22;
}
function Ae2(e2, t2, n2) {
  n2.inline = true;
  let i2 = e2[2] ? e2[2].replace(W2, "").split("|").map(ze2) : [], l22 = e2[3] ? (function(e3, t3, n3) {
    return e3.trim().split(`
`).map(function(e4) {
      return Le2(e4, t3, n3, true);
    });
  })(e2[3], t2, n2) : [], a2 = Le2(e2[1], t2, n2, !!l22.length);
  return n2.inline = false, l22.length ? { align: i2, cells: l22, header: a2, type: r.table } : { children: a2, type: r.paragraph };
}
function Te2(e2, t2) {
...
function Ie2(e2, t2) {
  ...
  let n2 = "";
  e2.split(`
`).every((e3) => !$e2.some((t3) => t3.test(e3)) && (n2 += e3 + `
`, e3.trim()));
  let r2 = n2.trimEnd();
...
function Ze2(n2 = "", i2 = {}) {
  function d22(e2, n3, ...r2) {
    let l22 = We2(i2.overrides, `${e2}.props`, {});
    return i2.createElement((function(e3, t2) {
      let n4 = We2(t2, e3);
      return n4 ? typeof n4 == "function" || typeof n4 == "object" && "render" in n4 ? n4 : We2(t2, `${e3}.component`, e3) : e3;
    })(e2, i2.overrides), t({}, n3, l22, { className: Ge2(n3 == null ? void 0 : n3.className, l22.className) || void 0 }), ...r2);
  }
  function W22(e2) {
    e2 = e2.replace($2, "");
    let t2 = false;
    i2.forceInline ? t2 = true : i2.forceBlock || (t2 = _.test(e2) === false);
    let n3 = le22(ie22(t2 ? e2 : `${e2.trimEnd().replace(ne2, "")}

`, { inline: t2 }));
    for (; typeof n3[n3.length - 1] == "string" && !n3[n3.length - 1].trim(); ) n3.pop();
    if (i2.wrapper === null) return n3;
    let r2 = i2.wrapper || (t2 ? "span" : "div"), l22;
    if (n3.length > 1 || i2.forceWrapper) l22 = n3;
    else {
      if (n3.length === 1) return l22 = n3[0], typeof l22 == "string" ? d22("span", { key: "outer" }, l22) : l22;
      l22 = null;
    }
    return i2.createElement(r2, { key: "outer" }, l22);
  }
  function Z22(e2, t2) {
    let n3 = t2.match(c);
    return n3 ? n3.reduce(function(t3, n4) {
      ...
      if (r2 !== -1) {
        let a2 = (function(e3) {
          return e3.indexOf("-") !== -1 && e3.match(B2) === null && (e3 = e3.replace(N3, function(e4, t4) {
            return t4.toUpperCase();
          })), e3;
        })(n4.slice(0, r2)).trim(), o22 = (function(e3) {
          let t4 = e3[0];
          return (t4 === '"' || t4 === "'") && e3.length >= 2 && e3[e3.length - 1] === t4 ? e3.slice(1, -1) : e3;
        })(n4.slice(r2 + 1).trim()), c2 = l2[a2] || a2;
        if (c2 === "ref") return t3;
        let s2 = t3[c2] = (function(e3, t4, n5, r3) {
          ...
          }, {}) : t4 === "href" || t4 === "src" ? r3(n5, e3, t4) : (n5.match(R2) && (n5 = n5.slice(1, n5.length - 1)), n5 === "true" || n5 !== "false" && n5);
        })(e2, a2, o22, i2.sanitizer);
        typeof s2 == "string" && (A2.test(s2) || M2.test(s2)) && (t3[c2] = W22(s2.trim()));
      } else n4 !== "style" && (t3[l2[n4] || n4] = true);
      return t3;
    }, {}) : null;
  }
  i2.overrides = i2.overrides || {}, i2.sanitizer = i2.sanitizer || Ue2, i2.slugify = i2.slugify || we2, i2.namedCodesToUnicode = i2.namedCodesToUnicode ? t({}, a, i2.namedCodesToUnicode) : a, i2.createElement = i2.createElement || React15.createElement;
  let q22 = [], Q22 = {}, V22 = { [r.blockQuote]: { match: Me2(p), order: 1, parse(e2, t2, n3) {
    let [, r2, i3] = e2[0].replace(u, "").match(f2);
    return { alert: r2, children: t2(i3, n3) };
  }, render(e2, t2, n3) {
    let l22 = { key: n3.key };
    return e2.alert && (l22.className = "markdown-alert-" + i2.slugify(e2.alert.toLowerCase(), we2), e2.children.unshift({ attrs: {}, children: [{ type: r.text, text: e2.alert }], noInnerParse: true, type: r.htmlBlock, tag: "header" })), d22("blockquote", l22, t2(e2.children, n3));
  } }, [r.breakLine]: { match: Re2(h2), order: 1, parse: Fe2, render: (e2, t2, n3) => d22("br", { key: n3.key }) }, [r.breakThematic]: { match: Me2(m), order: 1, parse: Fe2, render: (e2, t2, n3) => d22("hr", { key: n3.key }) }, [r.codeBlock]: { match: Me2(y2), order: 0, parse: (e2) => ({ lang: void 0, text: e2[0].replace(/^ {4}/gm, "").replace(/\n+$/, "") }), render: (e2, n3, r2) => d22("pre", { key: r2.key }, d22("code", t({}, e2.attrs, { className: e2.lang ? `lang-${e2.lang}` : "" }), e2.text)) }, [r.codeFenced]: { match: Me2(g2), order: 0, parse: (e2) => ({ attrs: Z22("code", e2[3] || ""), lang: e2[2] || void 0, text: e2[4], type: r.codeBlock }) }, [r.codeInline]: { match: Be2(k2), order: 3, parse: (e2) => ({ text: e2[2] }), render: (e2, t2, n3) => d22("code", { key: n3.key }, e2.text) }, [r.footnote]: { match: Me2(v2), order: 0, parse: (e2) => (q22.push({ footnote: e2[2], identifier: e2[1] }), {}), render: _e3 }, [r.footnoteReference]: { match: Oe2(S2), order: 1, parse: (e2) => ({ target: `#${i2.slugify(e2[1], we2)}`, text: e2[1] }), render: (e2, t2, n3) => d22("a", { key: n3.key, href: i2.sanitizer(e2.target, "a", "href") }, d22("sup", { key: n3.key }, e2.text)) }, [r.gfmTask]: { match: Oe2(E), order: 1, parse: (e2) => ({ completed: e2[1].toLowerCase() === "x" }), render: (e2, t2, n3) => d22("input", { checked: e2.completed, key: n3.key, readOnly: true, type: "checkbox" }) }, [r.heading]: { match: Me2(i2.enforceAtxHeadings ? z3 : w2), order: 1, parse: (e2, t2, n3) => ({ children: Ne2(t2, e2[2], n3), id: i2.slugify(e2[2], we2), level: e2[1].length }), render: (e2, t2, n3) => d22(`h${e2.level}`, { id: e2.id, key: n3.key }, t2(e2.children, n3)) }, [r.headingSetext]: { match: Me2(L), order: 0, parse: (e2, t2, n3) => ({ children: Ne2(t2, e2[1], n3), level: e2[2] === "=" ? 1 : 2, type: r.heading }) }, [r.htmlBlock]: { match: Re2(A2), order: 1, parse(e2, t2, n3) {
    let [, r2] = e2[3].match(re2), i3 = new RegExp(`^${r2}`, "gm"), l22 = e2[3].replace(i3, ""), a2 = (c2 = l22, Ee2.some((e3) => e3.test(c2)) ? He2 : Ne2);
    var c2;
    let s2 = e2[1].toLowerCase(), d3 = o2.indexOf(s2) !== -1, p2 = (d3 ? s2 : e2[1]).trim(), u2 = { attrs: Z22(p2, e2[2]), noInnerParse: d3, tag: p2 };
    return n3.inAnchor = n3.inAnchor || s2 === "a", d3 ? u2.text = e2[3] : u2.children = a2(t2, l22, n3), n3.inAnchor = false, u2;
  }, render: (e2, n3, r2) => d22(e2.tag, t({ key: r2.key }, e2.attrs), e2.text || (e2.children ? n3(e2.children, r2) : "")) }, [r.htmlSelfClosing]: { match: Re2(M2), order: 1, parse(e2) {
    let t2 = e2[1].trim();
    return { attrs: Z22(t2, e2[2] || ""), tag: t2 };
  }, render: (e2, n3, r2) => d22(e2.tag, t({}, e2.attrs, { key: r2.key })) }, [r.htmlComment]: { match: Re2(O2), order: 1, parse: () => ({}), render: _e3 }, [r.image]: { match: Be2(Ce2), order: 1, parse: (e2) => ({ alt: e2[1], target: De2(e2[2]), title: e2[3] }), render: (e2, t2, n3) => d22("img", { key: n3.key, alt: e2.alt || void 0, title: e2.title || void 0, src: i2.sanitizer(e2.target, "img", "src") }) }, [r.link]: { match: Oe2(Se2), order: 3, parse: (e2, t2, n3) => ({ children: je2(t2, e2[1], n3), target: De2(e2[2]), title: e2[3] }), render: (e2, t2, n3) => d22("a", { key: n3.key, href: i2.sanitizer(e2.target, "a", "href"), title: e2.title }, t2(e2.children, n3)) }, [r.linkAngleBraceStyleDetector]: { match: Oe2(D2), order: 0, parse: (e2) => ({ children: [{ text: e2[1], type: r.text }], target: e2[1], type: r.link }) }, [r.linkBareUrlDetector]: { match: (e2, t2) => t2.inAnchor || i2.disableAutoLink ? null : Oe2(I2)(e2, t2), order: 0, parse: (e2) => ({ children: [{ text: e2[1], type: r.text }], target: e2[1], title: void 0, type: r.link }) }, [r.linkMailtoDetector]: { match: Oe2(U), order: 0, parse(e2) {
    let t2 = e2[1], n3 = e2[1];
    return s.test(n3) || (n3 = "mailto:" + n3), { children: [{ text: t2.replace("mailto:", ""), type: r.text }], target: n3, type: r.link };
  } }, [r.orderedList]: ve2(d22, 1), [r.unorderedList]: ve2(d22, 2), [r.newlineCoalescer]: { match: Me2(x2), order: 3, parse: Fe2, render: () => `
` }, [r.paragraph]: { match: Ie2, order: 3, parse: Pe2, render: (e2, t2, n3) => d22("p", { key: n3.key }, t2(e2.children, n3)) }, [r.ref]: { match: Oe2(H2), order: 0, parse: (e2) => (Q22[e2[1]] = { target: e2[2], title: e2[4] }, {}), render: _e3 }, [r.refImage]: { match: Be2(P2), order: 0, parse: (e2) => ({ alt: e2[1] || void 0, ref: e2[2] }), render: (e2, t2, n3) => Q22[e2.ref] ? d22("img", { key: n3.key, alt: e2.alt, src: i2.sanitizer(Q22[e2.ref].target, "img", "src"), title: Q22[e2.ref].title }) : null }, [r.refLink]: { match: Oe2(F2), order: 0, parse: (e2, t2, n3) => ({ children: t2(e2[1], n3), fallbackChildren: e2[0], ref: e2[2] }), render: (e2, t2, n3) => Q22[e2.ref] ? d22("a", { key: n3.key, href: i2.sanitizer(Q22[e2.ref].target, "a", "href"), title: Q22[e2.ref].title }, t2(e2.children, n3)) : d22("span", { key: n3.key }, e2.fallbackChildren) }, [r.table]: { match: Me2(j2), order: 1, parse: Ae2, render(e2, t2, n3) {
    let r2 = e2;
    return d22("table", { key: n3.key }, d22("thead", null, d22("tr", null, r2.header.map(function(e3, i3) {
      return d22("th", { key: i3, style: Te2(r2, i3) }, t2(e3, n3));
    }))), d22("tbody", null, r2.cells.map(function(e3, i3) {
      return d22("tr", { key: i3 }, e3.map(function(e4, i4) {
        return d22("td", { key: i4, style: Te2(r2, i4) }, t2(e4, n3));
      }));
    })));
  } }, [r.text]: { match: Re2(te3), order: 4, parse: (e2) => ({ text: e2[0].replace(T2, (e3, t2) => i2.namedCodesToUnicode[t2] ? i2.namedCodesToUnicode[t2] : e3) }), render: (e2) => e2.text }, [r.textBolded]: { match: Be2(X2), order: 2, parse: (e2, t2, n3) => ({ children: t2(e2[2], n3) }), render: (e2, t2, n3) => d22("strong", { key: n3.key }, t2(e2.children, n3)) }, [r.textEmphasized]: { match: Be2(J2), order: 3, parse: (e2, t2, n3) => ({ children: t2(e2[2], n3) }), render: (e2, t2, n3) => d22("em", { key: n3.key }, t2(e2.children, n3)) }, [r.textEscaped]: { match: Be2(ee2), order: 1, parse: (e2) => ({ text: e2[1], type: r.text }) }, [r.textMarked]: { match: Be2(K2), order: 3, parse: Pe2, render: (e2, t2, n3) => d22("mark", { key: n3.key }, t2(e2.children, n3)) }, [r.textStrikethroughed]: { match: Be2(Y2), order: 3, parse: Pe2, render: (e2, t2, n3) => d22("del", { key: n3.key }, t2(e2.children, n3)) } };
  i2.disableParsingRawHTML === true && (delete V22[r.htmlBlock], delete V22[r.htmlSelfClosing]);
  let ie22 = (function(e2) {
    ...
    function n3(r2, i3) {
      ...
      for (i3.prevCapture = i3.prevCapture || ""; r2; ) {
        let a2 = 0;
        for (; a2 < t2.length; ) {
          let o22 = t2[a2], c2 = e2[o22], s2 = c2.match(r2, i3);
          if (s2) {
            let e3 = s2[0];
            i3.prevCapture += e3, r2 = r2.substring(e3.length);
            let t3 = c2.parse(s2, n3, i3);
            t3.type == null && (t3.type = o22), l22.push(t3);
            break;
          }
          a2++;
        }
      }
      return i3.prevCapture = "", l22;
    }
...
`).replace(C2, "").replace(G2, "    ");
      })(e3), t3);
    };
  })(V22), le22 = (ae22 = /* @__PURE__ */ (function(e2, t2) {
    return function(n3, r2, i3) {
      let l22 = e2[n3.type].render;
      return t2 ? t2(() => l22(n3, r2, i3), n3, r2, i3) : l22(n3, r2, i3);
    };
  })(V22, i2.renderRule), function e2(t2, n3 = {}) {
    if (Array.isArray(t2)) {
      let r2 = n3.key, i3 = [], l22 = false;
      for (let r3 = 0; r3 < t2.length; r3++) {
        n3.key = r3;
        let a2 = e2(t2[r3], n3), o22 = typeof a2 == "string";
        o22 && l22 ? i3[i3.length - 1] += a2 : a2 !== null && i3.push(a2), l22 = o22;
      }
      return n3.key = r2, i3;
    }
    return ae22(t2, e2, n3);
  });
  var ae22;
  let oe22 = W22(n2);
  return q22.length ? d22("div", null, oe22, d22("footer", { key: "footer" }, q22.map(function(e2) {
    return d22("div", { id: i2.slugify(e2.identifier, we2), key: e2.identifier }, e2.identifier, le22(ie22(e2.footnote, { inline: true })));
  }))) : oe22;
}
var index_modern_default = (t2) => {
  let { children: r2 = "", options: i2 } = t2, l22 = (function(e2, t3) {
    if (e2 == null) return {};
    var n2, r3, i3 = {}, l3 = Object.keys(e2);
    for (r3 = 0; r3 < l3.length; r3++) t3.indexOf(n2 = l3[r3]) >= 0 || (i3[n2] = e2[n2]);
    return i3;
  })(t2, n);
  return React15.cloneElement(Ze2(r2, i2), l22);
};
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-YHDXOIA2-OBPR67LP.js"));
...
var sortFns = { alpha: (a2, b22) => a2.name.localeCompare(b22.name), requiredFirst: (a2, b22) => {
  var _a, _b;
  return +!!((_a = b22.type) == null ? void 0 : _a.required) - +!!((_b = a2.type) == null ? void 0 : _b.required) || a2.name.localeCompare(b22.name);
}, none: void 0 };
...
var Canvas = (props) => {
  var _a, _b, _c, _d, _e4, _f, _g, _h, _i, _j;
...
var getDescriptionFromResolvedOf = (resolvedOf) => {
  ...
  switch (resolvedOf.type) {
    ...
    case "meta": {
      ...
      return metaDescription || ((_f = (_e4 = parameters.docs) == null ? void 0 : _e4.extractComponentDescription) == null ? void 0 : _f.call(_e4, component, { component, parameters })) || null;
    }
    case "component": {
...
var DocsContainer = ({ context, theme, children }) => {
  ...
  try {
    ...
    toc = (_e4 = (_d = (_c = context == null ? void 0 : context.projectAnnotations) == null ? void 0 : _c.parameters) == null ? void 0 : _d.docs) == null ? void 0 : _e4.toc;
  }
  return (0, import_react.useEffect)(() => {
    let url;
    try {
...
// node_modules/.pnpm/@storybook+react-dom-shim@8.6.14_react-dom@19.2.4_react@19.2.4__react@19.2.4_storybook@8.6.18/node_modules/@storybook/react-dom-shim/dist/react-18.mjs
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-E3P66ZNC.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=DocsRenderer-CFRXHY34-LUJVZ6TS.js.map
